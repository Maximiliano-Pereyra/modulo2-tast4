 ...
 const mainArray = (data) => {
    ...
    function cardPrinter(print) {
        ...
        <img src="${print.image}" style="border-solid-dark" alt="..." width="280px" height="200px" </img>
                                   ...
                                   <a href="./details.html?id=${print.id}" class="btn btn-primary btnCard">Buy</a>
                                   </div>   
                                   `
    ...
    <input class="form-check-input checkb checkBox" type="checkbox" id="${element}" value="${element}">
